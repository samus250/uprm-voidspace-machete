...
public class EnemyShip extends Rectangle {
	 ...
	 * @param enemyBulletTime - the enemy ship's bullet time
	 */
	 ...
	 * @param time - the enemy ship's last time.
	 */
	 ...
	 * @param status - should be true if the enemy ship is new, false otherwise
	 */
