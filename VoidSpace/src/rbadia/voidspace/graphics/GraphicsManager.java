...
public class GraphicsManager {
	...
	public GraphicsManager(){
		...
		try {
			...
			this.chuckNorrisImg = ImageIO.read(getClass().getResource("/rbadia/voidspace/graphics/CHUCK_NORRIS_INDESTRUCTABLE.png"));
		} catch (Exception e) {
	 ...
	 * @param chuckNorris the chucknorris to draw
	 * @param g2d the graphics canvas
	 * @param observer object to be notified
	 */
	 ...
	 * @param ship - the enemy ship to draw
	 * @param g2d - the graphics canvas
	 ...
	 * @param bullet - the enemy bullet to draw
	 * @param g2d - the graphics canvas
	 * @param observer - the object to be notified
	 */
